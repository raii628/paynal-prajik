  ...
  return (
    <>
      ...
      <div className="fixed inset-0 flex items-center justify-center z-40">
        <section className="relative z-30 min-h-screen flex items-center justify-center mt-5">
                ...
                <div className="mb-2">
                  ...
                  <div className="relative">
                    ...
                    <motion.input
                      ...
                      className="z-10 border border-gray-600 text-sm text-gray-900 rounded-md focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 pl-9 mt-1"
                      required
                    />
                    {errors.email && (
                ...
                <div className="mb-4 relative">
                  ...
                  <div className="relative flex items-center">
                    ...
                    <motion.input
                      ...
                      className="bg-gray-50 border border-gray-600 text-sm text-gray-900 rounded-md focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 pl-9 mt-1"
                      required
                    />
                    <FontAwesomeIcon
