  ...
  const rooms = [
    {
      ...
      availableRooms: 10, // from reference
      price: 4000,
    },
    {
      image: deluxe_double,
      ...
      availableRooms: 7, // from reference
      price: 5000,
    },
    {
      image: deluxe_twin,
      ...
      availableRooms: 3, // from reference
      price: 5500,
    },
    {
    ...
    },
    {
      ...
      capacity: 2,
      bedType: "1 king bed",
      availableRooms: 5, // from reference
      price: 20000,
    },
  ];
