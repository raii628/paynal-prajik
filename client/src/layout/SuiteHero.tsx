...
import suite_bg from "../assets/suite_bg.webp";

const SuiteHero = () => {
  return (
    <section
      className=" h-screen bg-cover bg-bottom relative before:absolute before:inset-0 before:bg-black/50 before:z-0"
      style={{ backgroundImage: `url(${suite_bg})` }}
    >
      <Navbar />
