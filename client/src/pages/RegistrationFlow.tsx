...
const RegistrationFlow: React.FC = () => {
    ...
    const handleCompleteRegistrationSubmit = async (e: FormEvent<HTMLFormElement>) => {
        ...
        setLoading(true);
        try {
            const response = await completeRegistration(email, password, firstName, lastName, age, gender);
            if (response.status === 200) {
                setNotification({
    ...
    const validateForm = () => {
        ...
        else if (parseInt(age) < 18) newErrors.age = "You must be at least 18 years old";
        setErrors(newErrors);
            ...
            <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50 px-4">
                ...
                {step === 3 && (
                    <motion.div
                        ...
                        transition={{ duration: 0.5 }}
                        className="bg-white w-full max-w-md rounded-lg shadow-xl p-8 mx-4"
                    >
                        <div className="flex flex-col items-center mb-6">
                            <motion.div
                        ...
                        <form onSubmit={handleCompleteRegistrationSubmit}>
                            ...
                            <motion.button
                                ...
                                type="submit"
                                disabled={loading}
                                className="w-full bg-blue-600 text-white py-2 rounded-md hover:bg-blue-700 transition-colors focus:outline-none"
                            >
